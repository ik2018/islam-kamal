...
Intent camedintent ;
    ...
    private void setUpMap() {
        ...
        mMap.addMarker(new MarkerOptions().position(new LatLng(contacts.get(camedintent.getIntExtra("position",0)).getLat(), contacts.get(camedintent.getIntExtra("position",0)).getLng())).title("Marker"));
